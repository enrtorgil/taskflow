...
<body
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">{{ __('app.get_started') }}</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">{{ __('app.welcome_description') }}</p>
    ...
    <script>
        ...
        // Si quieres permitir alternar manualmente con un botón
